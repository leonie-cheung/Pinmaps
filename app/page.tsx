...
export default function App() {
  ...
  const navItems = ["Friends", "Explore", "Nearby", "Map"] as const;
  const dropdownOptions = ["Profile", "Save", "Post", "Settings"] as const;

  const dropdownRoutes: Record<(typeof dropdownOptions)[number], string> = {
    Profile: "/profile",
    Save: "/save",
    Post: "/post",
    Settings: "/settings",
